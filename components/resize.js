...
function validateInput(base64String, maxWidth, maxHeight) {
  ...
  if (!base64String) {
    validationResult.errorMessage =
      "The input parameter base64String is " + base64String + ".";
  } else if (typeof base64String != "string") {
    validationResult.errorMessage =
      "The input parameter base64String is not of type 'string'.";
  } else if (!base64String.startsWith("data:image")) {
    validationResult.errorMessage =
      "The input parameter base64String does not start with 'data:image'.";
  } else if (!maxWidth) {
    validationResult.errorMessage =
      "The input parameter maxWidth is " + maxWidth + ".";
  } else if (typeof maxWidth != "number") {
    validationResult.errorMessage =
      "The input parameter maxWidth is not of type 'number'.";
  } else if (maxWidth < 2) {
    validationResult.errorMessage =
      "The input parameter maxWidth must be at least 2 pixel.";
  } else if (!maxHeight) {
    validationResult.errorMessage =
      "The input parameter maxHeight is " + maxHeight + ".";
  } else if (typeof maxHeight != "number") {
    validationResult.errorMessage =
      "The input parameter maxHeight is not of type 'number'.";
  } else if (maxHeight < 2) {
    validationResult.errorMessage =
      "The input parameter maxHeight must be at least 2 pixel.";
  } else {
...
function maxWidthRatioFunction(
  imageWidth,
  imageHeight,
  targetWidth,
  targetHeight
...
function maxHeightRatioFunction(
  imageWidth,
  imageHeight,
  targetWidth,
  targetHeight
...
function maxWidthMaxHeightRatioFunction(
  imageWidth,
  imageHeight,
  targetWidth,
  targetHeight
...
function resizeBase64ForMaxWidth(
  base64String,
  maxWidth,
  maxHeight,
  successCallback,
...
function resizeBase64ForMaxHeight(
  base64String,
  maxWidth,
  maxHeight,
  successCallback,
...
function resizeBase64ForMaxWidthAndMaxHeight(
  base64String,
  maxWidth,
  maxHeight,
  successCallback,
  ...
  if (validationResult.isValid === true) {
    resizeBase64(
      ...
      maxWidth,
      maxHeight,
      maxWidthMaxHeightRatioFunction,
      successCallback,
      errorCallback
    );
  } else {
